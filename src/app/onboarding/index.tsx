...
export default function OnboardingIntroScreen() {
  return (
    ...
    >
      {/* No ScrollView here on purpose — a ScrollView wrapping this Pressable footer was
          intermittently swallowing taps (a known scroll-vs-tap gesture conflict on web). Sized to
          comfortably fit a short real phone viewport (iPhone SE height, ~667px) without scrolling
          instead. */}
