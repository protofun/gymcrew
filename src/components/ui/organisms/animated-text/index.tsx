// GymCrew patch: the original per-character blur layer (expo-blur) was removed — expo-blur is not part
// of the app's native build. Everything else (staggered spring reveal, exit, layout) is unchanged.
