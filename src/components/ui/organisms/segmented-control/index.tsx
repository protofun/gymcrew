// GymCrew patch: the decorative blur layer (expo-blur) was removed — expo-blur is not part of the app's
// native build. Behaviour is otherwise unchanged.
...
const styles = StyleSheet.create({
  ...
  // GymCrew patch: centre the label in its segment — it used to sit at the left edge of it.
  textWrapper: {
    flex: 1,
    elevation: 9,
    paddingHorizontal: 5,
